...
class Ragtek_MM_Install
{
    ...
    protected function _installVersion16(){
         $query = array();
        ...
        self::addColumn(self::ADDON_PRIMARY_TABLE,'reply_creator_user_id',' INT( 10 ) UNSIGNED NOT NULL');
    ...
    protected function _installVersion15(){
         $query = array();
    ...
    public function _installVersion10(){
        if (!self::checkIfIndexExists(self::ADDON_PRIMARY_TABLE, 'title')){
    ...
    public static function addColumn($table, $field, $attr)
    {
        if (!self::checkIfExist($table, $field)) {
            $db = XenForo_Application::getDb();
            $query = "ALTER TABLE `" . $table . "` ADD `" . $field . "` " . $attr;
